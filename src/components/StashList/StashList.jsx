...
export default function StashList({fnList}) {
  ...
  return (
    <div className='overflow-scroll no-scrollbar' style={{flexGrow: 1}}>
        ...
        {
            fnList.map(([fn,id])=>{
                return <div key={id} className={'h-10 cursor-pointer w-full flex items-center justify-center mt-2 bg-green-200 border hover:bg-green-400 border-gray-300 transition '+styles.box}>
